...
return [
    ...
    */
    'resources'     => [
        ...
        'user-roles'            => UserRoleModel::class,
        'subscriptions'         => SubscriptionsModel::class,
        'subscription-actions'  => SubscriptionActionsModel::class,
        'subscription-channels' => SubscriptionChannelsModel::class,
    ],
